...
from ccus_gym.physical import PhysicalLayer, PhysicalOutcome
from ccus_gym.disruptions import DisruptionGenerator, MechanismAxes
from ccus_gym.network import CCUSNetwork, TransportType
from ccus_gym.configs import MINIMAL_NETWORK_CONFIG
...
class CCUSEnv(ParallelEnv):
    ...
    def _pregenerate_disruption_schedule(self) -> None:
        ...
        from ccus_gym.disruptions import DisruptionGenerator
